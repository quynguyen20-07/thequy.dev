      ...
      <div className="pt-16">
        ...
        <header className="relative py-20 px-4 sm:px-6 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <span className="tag-accent mb-4 inline-block">Let's Work Together</span>
            <h1 className="text-4xl sm:text-5xl font-black text-white mb-4">
              Get In{' '}
              <span className="gradient-text">Touch</span>
            </h1>
            <p className="text-slate-400 text-lg max-w-xl mx-auto">
              Have a project in mind or want to discuss opportunities? I'm always open to new conversations.
            </p>
          </div>
        </header>
            ...
            <section aria-label="Contact information">
              ...
              <div className="space-y-4">
                {contactMethods.map((method) => (
                  ...
                  >
                    <div className={`w-10 h-10 rounded-xl glass flex items-center justify-center ${method.iconColor} group-hover:scale-110 transition-transform shrink-0`}>
                      {method.icon}
                    </div>
                    <div className="min-w-0">
                      <div className="text-slate-400 text-xs mb-0.5">{method.label}</div>
                      <div className="text-white font-semibold text-sm truncate">{method.value}</div>
                      <div className="text-slate-500 text-xs">{method.description}</div>
                    </div>
                    <svg className="w-4 h-4 text-slate-600 group-hover:text-slate-400 ml-auto transition-colors shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="mt-8 card">
                <h3 className="text-white font-bold mb-3 text-sm">📍 Location</h3>
                <p className="text-slate-400 text-sm">21 Bui Ky, Cam Le District</p>
                <p className="text-slate-400 text-sm">Da Nang, Vietnam 🇻🇳</p>
                <p className="text-slate-500 text-xs mt-2">Timezone: GMT+7 (Indochina Time)</p>
              </div>
              ...
              <div className="mt-4 glass rounded-2xl p-5 border border-accent-500/20">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="text-accent-400 font-bold text-sm">Currently Available</h3>
                </div>
                <p className="text-slate-400 text-xs leading-relaxed">
                  Open to freelance projects, full-time opportunities, and technical collaborations. I typically respond within 24 hours.
                </p>
              </div>
            </section>
              ...
              {submitted ? (
                <div className="glass rounded-2xl p-10 text-center border border-accent-500/30">
                  ...
                  <p className="text-slate-400 text-sm">
                    Your email client has opened. Thank you for reaching out — I'll get back to you soon.
                  </p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="space-y-4" noValidate aria-label="Contact form">
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      <label htmlFor="contact-name" className="block text-slate-400 text-xs mb-1.5 font-medium">
                    ...
                    <div>
                      <label htmlFor="contact-email" className="block text-slate-400 text-xs mb-1.5 font-medium">
                  ...
                  <div>
                    <label htmlFor="contact-subject" className="block text-slate-400 text-xs mb-1.5 font-medium">
                      Subject
                    </label>
                    <input
                      id="contact-subject"
                  ...
                  <div>
                    <label htmlFor="contact-message" className="block text-slate-400 text-xs mb-1.5 font-medium">
